# -*- coding: utf-8 -*-
""" Algoritmo do Projeto Classificação Pneumonia - Versão Ihago

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OEo1ULpA7EevvZGxswo2C7gKsnl8YeM3
"""
...
!unzip '/content/drive/MyDrive/pneumoniadataset/PNEUMONIA.zip'
...
base_teste = gerador_teste.flow_from_directory('/content/chest_xray/test',
                                               target_size = (64, 64),
                                               batch_size = 32,
                                               class_mode = 'binary')
...
imagem_teste = load_img('/content/chest_xray/test/NORMAL/IM-0001-0001.jpeg',
                              target_size = (64,64))
